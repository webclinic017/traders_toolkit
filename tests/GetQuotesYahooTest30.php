...
/**
 * Test case: timeOfInquiry = Trading Day (T) Fri-05-Aug-2016 0000-0930, timeOfLastUpdateOfTheQuoteFile = no_quote_file
 * Mock historical data is used. No internet connection required.
 */
class GetQuotesYahooTest30 extends TestCase
{
    /**
    ...
    {
        fwrite(STDOUT,"\nTest case for when No OHLCV file present. Testing download of historical quotes for inquiry occurring at T any time between 0000 and 0929: ");
        ...
        // $now = $faker->dateTimeBetween($startDate = '2016-08-05 00:00:00', $endDate = '2016-08-05 09:29:59', $timezone = 'America/New_York');
        //$now = $faker->dateTimeInInterval($startDate = '2016-08-05 00:00:00', $interval = '+ 9 hours 30 minutes', $timezone = 'America/New_York');
        ...
        fwrite(STDOUT, $now->format(DateTime::W3C) . "\n");
