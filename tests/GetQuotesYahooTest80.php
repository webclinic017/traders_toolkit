...
/**
 * Test case: timeOfInquiry = Trading Day (T) Fri-05-Aug-2016 0930-2359, timeOfLastUpdateOfTheQuoteFile = T-2 Wed-03-Aug-2016
...
class GetQuotesYahooTest80 extends TestCase
{
    ...
    {
        fwrite(STDOUT,"\nTest case: timeOfInquiry = Trading Day (T) Fri-05-Aug-2016 0930-2359, timeOfLastUpdateOfTheQuoteFile = T-2 Thu-03-Aug-2016. Inquiry time: ");
