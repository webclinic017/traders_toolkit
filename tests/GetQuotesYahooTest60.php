...
/**
 * Test case: timeOfInquiry = Trading Day (T) Fri-05-Aug-2016 0930-2359, timeOfLastUpdateOfTheQuoteFile = T-1 Thu-04-Aug-2016
 * Mock historical data is used. No internet connection required.
 */

class GetQuotesYahooTest60 extends TestCase
{
    /**
    ...
    protected function setUp() 
    {
        ...
        $randomOffsetInSeconds = rand(9*3600+30*60, 23*3600+59*60);
    ...
    {
        fwrite(STDOUT,"\nTest case: timeOfInquiry = Trading Day (T) Fri-05-Aug-2016 0000-0930, timeOfLastUpdateOfTheQuoteFile = T-1 Thu-04-Aug-2016. Inquiry time: ");
        ...
        $line = $csv->current();
        $this->assertArraySubset($line, $this->testOHLCVFile['query']['results']['quote'][$lastLineIndex - 1]);
