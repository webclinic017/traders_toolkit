...
/**
 * Test case: timeOfInquiry = Trading Day (T) Fri-05-Aug-2016 0000-0930, timeOfLastUpdateOfTheQuoteFile = T-1 Thu-04-Aug-2016
 * Mock historical data is used. No internet connection required.
 */

class GetQuotesYahooTest50 extends TestCase
{
    /**
    ...
    public function testOHLCV()
    {
        ...
        $line = $csv->current();
        $this->assertArraySubset($line, $this->testOHLCVFile['query']['results']['quote'][$lastLineIndex]);
