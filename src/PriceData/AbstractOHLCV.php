...
abstract class AbstractOHLCV
{
	...
	*/
	...
	const COLUMN_0 = 'Timestamp';
	const COLUMN_1 = 'Open';
	const COLUMN_2 = 'High';
	const COLUMN_3 = 'Low';
	const COLUMN_4 = 'Close';
	const COLUMN_5 = 'Volume';
	...
	*/
	abstract public function downloadHistory($symbol, $fromDate, $toDate, $unit);
