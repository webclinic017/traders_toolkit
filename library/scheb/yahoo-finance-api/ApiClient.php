...
class ApiClient
{
    ...
    /**
     * Get current quote for one symbol
     *
     * @param string $symbol
     * @return array
     * @throws \Scheb\YahooFinanceApi\Exception\ApiException
    ...
    {
        $query = "select * from html where url='http://finance.yahoo.com/quote/" . $symbol . "?p=" . $symbol . "' and xpath='//div[@id=\"quote-summary\"]//table//tr'";
        return $this->execQuery($query);
    }
